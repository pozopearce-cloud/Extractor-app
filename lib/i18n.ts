...
export const translations: Record<AppLanguage, UiTranslations> = {
  es: {
    ...
    uploadHint: 'Solo PDFs con texto embebido. Esta v1 no incluye OCR para documentos escaneados.',
    ...
    serverPdfNoText: 'No se pudo extraer texto legible del PDF. Esta versión no soporta OCR.',
  ...
  en: {
    ...
    uploadHint: 'Text-based PDFs only. This v1 does not include OCR for scanned documents.',
    ...
    serverPdfNoText: 'No readable text could be extracted from the PDF. This version does not support OCR.',
  ...
  fr: {
    ...
    uploadHint: 'PDF avec texte intégré uniquement. Cette v1 ne prend pas en charge l’OCR pour les documents scannés.',
    ...
    serverPdfNoText: 'Aucun texte lisible n’a pu être extrait du PDF. Cette version ne prend pas en charge l’OCR.',
  ...
  zh: {
    ...
    uploadHint: '仅支持带可提取文本的 PDF。此 v1 不支持扫描件 OCR。',
    limitsTitle: 'MVP 限制',
    ...
    serverPdfNoText: '无法从 PDF 中提取可读文本。此版本不支持 OCR。',
